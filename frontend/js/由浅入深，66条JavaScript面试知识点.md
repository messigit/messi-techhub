...
![img](https://user-gold-cdn.xitu.io/2020/5/30/172652461dee1370?imageView2/0/w/1280/h/960/ignore-error/1)

**下面进入正题：**



[1.介绍一下js的数据类型有哪些,值是如何存储的](#1.介绍一下js的数据类型有哪些，值是如何存储的)
...
[8. {}和[\]的valueOf和toString的结果是什么？](#8.{}和[]的valueof和tostring的结果是什么？)
...
[32.   requireJS的核心原理是什么？](#32-requireJS的核心原理是什么？) [33. 谈谈JS的运行机制](#33-谈谈JS的运行机制)
...
[37. 哪些操作会造成内存泄漏？](#37-哪些操作会造成内存泄漏？) [38. ECMAScript 是什么？](#38-ECMAScript是什么？)
...
———— 高能预警分割线⚡————— [47. 写一个通用的事件侦听器函数，为什么要用它？](#47-写一个通用的事件侦听器函数)
...
![img](https://user-gold-cdn.xitu.io/2020/5/28/1725b947653323df?imageView2/0/w/1280/h/960/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2020/7/2/1730ee989aa2b15f?imageView2/0/w/1280/h/960/ignore-error/1)





![img](https://user-gold-cdn.xitu.io/2020/6/2/1727407aed442084?imageView2/0/w/1280/h/960/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2020/6/2/172744a7fa2853c4?imageView2/0/w/1280/h/960/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2020/6/1/1726f21a7f6f36a8?imageView2/0/w/1280/h/960/ignore-error/1)
